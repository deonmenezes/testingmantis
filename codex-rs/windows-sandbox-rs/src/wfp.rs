...
const SESSION_NAME: &str = "Mantis Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Mantis Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Mantis Windows sandbox filters";
const SUBLAYER_NAME: &str = "Mantis Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Mantis Windows sandbox filters";
...
/// Installs the persistent Mantis WFP filters for `account`.
///
...
/// Ensures the persistent Mantis WFP provider exists.
...
/// Ensures the persistent Mantis sublayer exists under the Mantis provider.
