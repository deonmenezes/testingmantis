...
//! "leave the old title alone" or "clear the title Mantis last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Mantis manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Mantis started managing the title.
